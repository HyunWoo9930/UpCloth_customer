...
class TodayRecommendScreen extends StatefulWidget {
  const TodayRecommendScreen({super.key});

  @override
  State<TodayRecommendScreen> createState() => _TodayRecommendScreenState();
}

class _TodayRecommendScreenState extends State<TodayRecommendScreen> {
...
Future<String> getItems() async {
  return await rootBundle.loadString('asset/json/today_recommend_item.json');
}
